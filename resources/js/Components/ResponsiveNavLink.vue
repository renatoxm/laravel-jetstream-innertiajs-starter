...
const classes = computed(() => {
  return props.active
    ...
    : 'block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-base-content hover:text-primary-content hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-primary-content focus:bg-gray-50 focus:border-gray-300 transition'
})
</script>
