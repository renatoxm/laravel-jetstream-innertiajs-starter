...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && !confirming" class="text-lg font-medium text-accent-content">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-accent-content">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-medium text-accent-content">
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div class="mt-4 max-w-xl text-sm text-base-content" v-if="setupKey">
