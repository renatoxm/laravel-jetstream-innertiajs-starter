            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-base-200 rounded-lg cursor-pointer">
                            <button v-for="(role, i) in availableRoles" :key="role.key" type="button"
                                ...
                                :class="{ 'border-t border-base-200 rounded-t-none': i > 0, 'rounded-b-none': i != Object.keys(availableRoles).length - 1 }"
                                ...
                                <div
                                    ...
                                    <!-- Role Description -->
                                    <div class="mt-2 text-xs text-base-content text-left">
                                        {{ role.description }}
                                    </div>
                                </div>
                            </button>
